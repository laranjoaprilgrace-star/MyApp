  ...
  const handleapprove = async (e, action) => {
    ...
    try {
      ...
      if (
        ...
        // Auto-open schedule modal instead of returning to the request slip list
                  ...
                  <div className="bg-white w-full max-w-2xl rounded-lg shadow-xl border border-gray-200">
                    <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
                      <div className="font-semibold text-gray-900">
                        {existingSchedule ? "Schedule Details" : "Create Schedule"}
                      </div>
                      <button
                    ...
                    <div className="p-4">
                      {scheduleError && (
                        <div className="mb-3 bg-red-50 text-red-500 p-3 rounded-lg text-sm">
                          {scheduleError}
                        </div>
                      )}
                      {scheduleSuccess && (
                        <div className="mb-3 bg-green-50 text-green-700 p-3 rounded-lg text-sm">
                          {scheduleSuccess}
                        </div>
                      )}
                      {isScheduleFetching ? (
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              ...
                              <input
                                type="text"
                                className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-100"
                                value={existingSchedule.title || "N/A"}
                                disabled
                              />
                            </div>
                            <div>
                              ...
                              <input
                                type="text"
                                className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-100"
                                value={existingSchedule.date ? new Date(existingSchedule.date).toLocaleDateString() : "N/A"}
                                disabled
                              />
                            </div>
                            <div>
                              ...
                              <input
                                type="text"
                                className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-100"
                                value={formatDisplayTime(existingSchedule.time) || "N/A"}
                                disabled
                              />
                            </div>
                            <div>
                              ...
                              <input
                                type="text"
                                className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-100"
                                value={existingSchedule.office?.name || requestDetails.requesting_office || "N/A"}
                                disabled
                              />
                            </div>
                            <div>
                              ...
                              <input
                                type="text"
                                className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-100"
                                value={existingSchedule.location || "N/A"}
                                disabled
                              />
                            </div>
                          </div>
                          <div>
                            ...
                            <textarea
                              className="w-full border border-gray-300 rounded-lg px-4 py-2 bg-gray-100"
                              rows="3"
                              value={existingSchedule.notes || "N/A"}
                              disabled
                            />
                          </div>
                          <div className="flex gap-4 pt-4">
                        ...
                        <form className="space-y-4" onSubmit={handleScheduleSubmit}>
                          ...
                          <div className="flex gap-4 pt-2">
                            <button
                              ...
                              className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed font-semibold transition-colors"
                            >
                              {isScheduleSubmitting ? "Scheduling..." : "Create Schedule"}
                            </button>
                          </div>
                        </form>
                      )}
