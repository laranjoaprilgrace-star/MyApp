...
const HeadMaintenance = () => {
  ...
  const handleNavigation = useCallback((item) => {
    if (item.text === 'Janitorial') navigate('/headJanitorial');
    if (item.text === 'Carpentry') navigate('/headCarpentry');
    if (item.text === 'Electrical') navigate('/headElectrical');
    if (item.text === 'Air-Conditioning') navigate('/headAirconditioning');
  }, [navigate]);
    ...
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        <HeadSidebar
          ...
          menuItems={HEAD_MENU_ITEMS} // <-- Use HEAD_MENU_ITEMS here
          title="Head"
        />
