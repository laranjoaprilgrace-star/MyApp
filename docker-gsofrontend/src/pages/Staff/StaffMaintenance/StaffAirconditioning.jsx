  ...
  const handleConfirmedSubmit = useCallback(async () => {
    ...
    try {
      ...
      const requestData = {
        ...
        maintenance_type_id: 4, // Air-conditioning maintenance type ID
      };

      // 👇 Log the requestData before sending to the backend
      console.log("Submitting air-conditioning request:", requestData);
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      placeholder="Please provide detailed information about your air-conditioning request"
                    ></textarea>
                    {status.fieldErrors.details && (
...
export default StaffAirconditioning;
