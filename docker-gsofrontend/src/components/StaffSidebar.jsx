...
const StaffNotificationProvider = ({ children }) => {
  ...
  const fetchUnreadCount = useCallback(async () => {
    try {
      ...
      const count = typeof data === 'number' ? data : 
                   ...
                   data.unread_count !== undefined ? data.unread_count : // <-- add this line
...
const MENU_ITEMS = [
  ...
  { text: "Notifications", to: "/staffnotifications", icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9", showBadge: true },
  ...
  { text: "Request Status", to: "/StaffRequeststatus", icon: "M9 2h6a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V3a1 1 0 1 1 1-1z M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2 M12 11h4 M12 16h4 M8 11h.01 M8 16h.01"},
...
export { StaffSidebar, MENU_ITEMS, StaffNotificationProvider, useNotifications, NotificationBadge };