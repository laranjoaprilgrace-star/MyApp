...
const CampusDirectorNotificationProvider = ({ children }) => {
...
const useNotifications = () => {
  ...
  if (!context) {
    throw new Error('useNotifications must be used within a CampusDirectorNotificationProvider');
  }
  return context;
};
...
// Campus Director Menu Items - Updated to include notification badge
const MENU_ITEMS = [
  ...
  { text: "Notifications", to: "/campusdirectornotifications", icon: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9", showBadge: true },
...
const CampusDirectorSidebar = memo(({ 
  isSidebarCollapsed, 
  onToggleSidebar,
  ...
  <aside className={`hidden md:block bg-gray-900 text-white transition-[width] duration-300 ease-in-out relative h-full z-20 ${
    ...
    <div className="p-4 flex flex-col justify-between h-full">
      ...
      <div className={`text-center text-xs md:text-sm text-gray-400 transition-opacity ${
        ...
        Campus Director Portal - Bantilan & Friends
      </div>
    </div>
  </aside>
));
...
const CampusDirectorSidebarDemo = () => {
        ...
        <div className="flex-1 p-6">
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow p-6">
              <h1 className="text-2xl font-bold text-gray-900 mb-4">Campus Director Dashboard</h1>
...
export default CampusDirectorSidebarDemo;

// Also export individual components for use in other parts of the application
export { CampusDirectorSidebar, MENU_ITEMS, CampusDirectorNotificationProvider, useNotifications, NotificationBadge };