  ...
  const handleConfirmedSubmit = useCallback(async () => {
    ...
    try {
      ...
      const requestData = {
        ...
        maintenance_type_id: 2, // Carpentry maintenance type ID
      };

      // 👇 Log the requestData before sending to the backend
      console.log("Submitting carpentry request:", requestData);
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      placeholder="Please provide detailed information about your carpentry request"
                    ></textarea>
                    {status.fieldErrors.details && (
